...
function fnBusPoint($vlu, $busNumber){
	...
	$busData = array(
		"YSa_신도림"=> "06:00|홈플러스 신도림점 앞"
		, "YSa_대림역"=> "06:07|대림역 2번출구 앞"
		, "YSa_사당역"=> "06:20|사당역 6번출구 방향 참약사 장수약국 앞"
		, "YSa_강남역"=> "06:35|강남역 1번출구 버스정류장"
		, "YSa_종합운동장역"=> "06:50|종합운동장역 4번출구 방향 버스정류장 뒤쪽"

		, "YJo_합정역"=> "05:50|합정역 3번출구 앞"
		, "YJo_종로3가역"=> "06:10|종로3가역 12번출구 새마을금고 앞"
		, "YJo_건대입구"=> "06:35|건대입구역 롯데백화점 스타시티점 입구"
		, "YJo_종합운동장역"=> "06:50|종합운동장역 4번출구 방향 버스정류장 뒤쪽"

		, "SY2_남애3리"=> "14:30|남애3리 입구"
		, "SY2_인구해변"=> "14:35|현남면사무소 맞은편"
		, "SY2_죽도해변"=> "14:42|GS25 죽도비치점 맞은편"
		, "SY2_기사문해변"=> "14:50|기사문 해변주차장 입구"
		, "SY2_서피비치"=> "15:00|서피비치 회전교차로 횡단보도 앞"

		, "SY5_남애3리"=> "17:30|남애3리 입구"
		, "SY5_인구해변"=> "17:35|현남면사무소 맞은편"
		, "SY5_죽도해변"=> "17:42|GS25 죽도비치점 맞은편"
		, "SY5_기사문해변"=> "17:50|기사문 해변주차장 입구"
		, "SY5_서피비치"=> "18:00|서피비치 회전교차로 횡단보도 앞"

		, "AE2_금진해변"=> "12:35|금진해변 공영주차장 입구"
		, "AE2_대진해변"=> "12:55|대진항 입구"
		, "AE2_솔.동해점"=> "13:00|솔.동해점 입구"

		, "AE5_금진해변"=> "17:35|금진해변 공영주차장 입구"
		, "AE5_대진해변"=> "17:55|대진항 입구"
		, "AE5_솔.동해점"=> "18:00|솔.동해점 입구"
	);
