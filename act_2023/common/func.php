...
function fnBusPoint($vlu, $busNumber){
	// $busNumberTmp = substr($busNumber, 0, 2);
	...
	$busData = array(
		...
		, "AE2_솔.동해점"=> "12:10|솔게스트하우스 동해서핑점 입구|37.5782382|129.1156248|17:10"
		//, "AE2_대진해변"=> "12:15|대진해변 공영주차장 입구|37.5807657|129.111344|17:15"
		//, "AE2_금진해변"=> "12:35|금진해변 공영주차장 입구|37.6347202|129.0450586|17:35"
		, "AE2_대진해변"=> "11:10|대진해변 공영주차장 입구|37.5807657|129.111344|17:15"
		, "AE2_금진해변"=> "11:30|금진해변 공영주차장 입구|37.6347202|129.0450586|17:35"
...
//셔틀버스 정류장 탑승시간, 위치
function fnBusPoint2023($point, $busNumber, $gubun){

	if($gubun == "사당"){
		$busData = array(
			  "신도림"=> "06:00|홈플러스 신도림점 앞|37.5095592|126.8885712"
			, "대림역"=> "06:07|대림역 2번출구 앞|37.4928008|126.8947074"
			, "사당역"=> "06:20|사당역 6번출구 방향 참약사 장수약국 앞|37.4764807|126.9777336"
			, "강남역"=> "06:35|강남역 1번출구 버스정류장|37.4982078|127.0290928"
			, "종합운동장역"=> "06:50|종합운동장역 4번출구 방향 버스정류장 뒤쪽|37.5104765|127.0722925"
		);
	}else if($gubun == "종로"){
		$busData = array(
			  "합정역"=> "05:50|합정역 3번출구 앞|37.5507926|126.9159159"
			, "종로3가역"=> "06:10|종로3가역 12번출구 새마을금고 앞|37.5703347|126.99317687"
			, "건대입구"=> "06:35|건대입구역 롯데백화점 스타시티점 입구|37.5393413|127.0716672"
			, "종합운동장역"=> "06:50|종합운동장역 4번출구 방향 버스정류장 뒤쪽|37.5104765|127.0722925"
		);
	}else if($gubun == "양양오후" || $gubun == "양양동해오후"){
		$busData = array(
			  "남애3리"=> "14:30|남애3리 입구|37.9452543|128.7814356"
			, "인구해변"=> "14:35|현남면사무소 맞은편|37.9689758|128.7599915"
			, "죽도해변"=> "14:42|GS25 죽도비치점 맞은편|37.9720003|128.7595433"
			, "기사문해변"=> "14:50|기사문 해변주차장 입구|38.0053627|128.7306342"
			, "서피비치"=> "15:00|서피비치 회전교차로 횡단보도 앞|38.0268271|128.7169575"
		);

		if($gubun == "양양동해오후"){
			$busData["솔.동해점"] = "12:50|솔게스트하우스 동해서핑점 입구|37.5782382|129.1156248";
			$busData["대진해변"] = "12:55|대진해변 공영주차장 입구|37.5807657|129.111344";
			$busData["나인비치"] = "13:00|나인비치 공영주차장 입구|37.589873|129.0949103";
			$busData["금진해변"] = "13:15|금진해변 공영주차장 입구|37.6347202|129.0450586";
		}
	}else if($gubun == "양양저녁" || $gubun == "양양동해저녁"){
		$busData = array(
			  "남애3리"=> "17:30|남애3리 입구|37.9452543|128.7814356"
			, "인구해변"=> "17:35|현남면사무소 맞은편|37.9689758|128.7599915"
			, "죽도해변"=> "17:42|GS25 죽도비치점 맞은편|37.9720003|128.7595433"
			, "기사문해변"=> "17:50|기사문 해변주차장 입구|38.0053627|128.7306342"
			, "서피비치"=> "18:00|서피비치 회전교차로 횡단보도 앞|38.0268271|128.7169575"
		);
	}else if($gubun == "동해오후"){
		$busData = array(
			  "솔.동해점"=> "12:50|솔게스트하우스 동해서핑점 입구|37.5782382|129.1156248"
			, "대진해변"=> "12:55|대진해변 공영주차장 입구|37.5807657|129.111344"
			, "나인비치"=> "13:00|나인비치 공영주차장 입구|37.589873|129.0949103"
			, "금진해변"=> "13:15|금진해변 공영주차장 입구|37.6347202|129.0450586"
		);
	}
