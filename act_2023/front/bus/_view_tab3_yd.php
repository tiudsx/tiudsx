<div style="display: block;padding-top:5px;">
        ...
        <table class="et_vars">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="오후차량" onclick="fnBusPoint(this);"></td>
                    <td style="text-align:center;"><input type="button" class="bd_btn" btnpoint="point" style="padding-top:4px;" value="저녁차량" onclick="fnBusPoint(this);"></td>
    ...
    <div class="bd" style="padding:10px 0 0px 0;">
        <table view="tbBus1" class="et_vars">
            ...
            <tbody>
                <tr>
                    <td colspan="3" height="28"><b>★ [양양,동해행] 사당선 셔틀버스</b></td>
                </tr>
                <tr>
        ...
        <table view="tbBus1" class="et_vars">
            <tbody>
                <tr>
                    <td height="28" style="border: 0px solid #DDD;">
                        <b>★ 도착정류장
                            <br><span style="padding-left:30px;">양양해변 : <?=fnBusPointList('busPoint_End_yy')?></span>
                            <br><span style="padding-left:30px;">동해해변 : <?=fnBusPointList('busPoint_End_dh')?></span>
                        </b>
                    </td>
                </tr>
            </tbody>
        ...
        <table view="tbBus2" class="et_vars" style="display: none;">
            ...
            <tbody>
                <tr>
                    <td colspan="3" height="28"><b>★ [양양,동해행] 종로선 셔틀버스</b></td>
                </tr>
                <tr>
                    <th style="text-align:center;"></th>
                    <th style="text-align:center;">탑승장소 및 시간</th>
                ...
                <tr>
                    <th>합정역</th>
                    <td><?=fnBusPointArr("YD-S-Jo_합정역", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-S-Jo_합정역", 1)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('Y', 2, 2, '합정역', this);"></td>
                </tr>
                <tr>
                    <th>종로3가역</th>
                    <td><?=fnBusPointArr("YD-S-Jo_종로3가역", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-S-Jo_종로3가역", 1)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('Y', 3, 2, '종로3가역', this);"></td>
                </tr>
                <tr>
                    <th>건대입구</th>
                    <td><?=fnBusPointArr("YD-S-Jo_건대입구", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-S-Jo_건대입구", 1)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('Y', 5, 2, '건대입구', this);"></td>
                </tr>
                <tr>
                    <th>종합운동장역</th>
                    <td><?=fnBusPointArr("YD-S-Jo_종합운동장역", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-S-Jo_종합운동장역", 1)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('Y', 6, 1, '종합운동장역', this);"></td>
                </tr>
            </tbody>
        ...
        <table view="tbBus3" class="et_vars" style="display: none;">
            ...
            <tbody>
                <tr>
                    <td colspan="4" height="28"><b>★ [오후차량] 서울행 셔틀버스</b></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th rowspan="3">동해</th>
                    <th>솔.동해점</th>
                    <td><?=fnBusPointArr("YD-E-E2_솔.동해점", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E2_솔.동해점", 3)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('A', 1, 1, '솔.동해점', this);"></td>
                </tr>
                <tr>
                    <th>대진해변</th>
                    <td><?=fnBusPointArr("YD-E-E2_대진해변", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E2_대진해변", 3)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('A', 2, 1, '대진해변', this);"></td>
                </tr>
                <tr>
                    <th>금진해변</th>
                    <td><?=fnBusPointArr("YD-E-E2_금진해변", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E2_금진해변", 3)?></font>
                    </td>
        ...
        <table view="tbBus4" class="et_vars" style="display: none;">
            ...
            <tbody>
                <tr>
                    <td colspan="3" height="28"><b>★ [저녁차량] 서울행 출발 셔틀버스</b></td>
                </tr>
                <tr>
                    <th style="text-align:center;"></th>
                    <th style="text-align:center;">탑승장소 및 시간</th>
                ...
                <tr>
                    <th>남애3리</th>
                    <td><?=fnBusPointArr("YD-E-E5_남애3리", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E5_남애3리", 3)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 2, 1, '남애3리', this);"></td>
                </tr>
                <tr>
                    <th>인구해변</th>
                    <td><?=fnBusPointArr("YD-E-E5_인구해변", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E5_인구해변", 3)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 3, 1, '인구해변', this);"></td>
                </tr>
                <tr>
                    <th>죽도해변</th>
                    <td><?=fnBusPointArr("YD-E-E5_죽도해변", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E5_죽도해변", 3)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 4, 1, '죽도해변', this);"></td>
                </tr>
                <tr>
                    <th>기사문해변</th>
                    <td><?=fnBusPointArr("YD-E-E5_기사문해변", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E5_기사문해변", 3)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 6, 1, '기사문해변', this);"></td>
                </tr>
                <tr>
                    <th>서피비치</th>
                    <td><?=fnBusPointArr("YD-E-E5_서피비치", 0)?><br>
                        <font color="red"><?=fnBusPointArr("YD-E-E5_서피비치", 3)?></font>
                    </td>
                    <td><input type="button" class="bd_btn mapviewid" style="padding-top:4px;" value="지도" onclick="fnBusMap('S', 7, 1, '서피비치', this);"></td>
                </tr>
            </tbody>
