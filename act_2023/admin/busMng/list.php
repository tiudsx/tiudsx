                        ...
                        <tr id="trbus" style="display:none;">
                            ...
                            <td style="text-align:center;">
                                <select id="res_busgubun" name="res_busgubun[]" class="select" sel="">
                                    ...
                                    <option value="Y|Sa1|사당선 2호차">양양행(사당선) 2호차</option>
                                    <option value="Y|Sa1|사당선 3호차">양양행(사당선) 3호차</option>
                                    <option value="Y|Jo1|종로선 1호차">양양행(종로선) 1호차</option>
                                    <option value="Y|Jo2|종로선 2호차">양양행(종로선) 2호차</option>
                                    <option value="Y|Jo2|종로선 3호차">양양행(종로선) 3호차</option>
                                    <option value="">-------</option>
                                    ...
                                    <option value="E|Sa1|사당선 2호차">동해행(사당선) 2호차</option>
                                    <option value="E|Sa1|사당선 3호차">동해행(사당선) 3호차</option>
                                    <option value="E|Jo1|종로선 1호차">동해행(종로선) 1호차</option>
                                    <option value="E|Jo2|종로선 2호차">동해행(종로선) 2호차</option>
                                    <option value="E|Jo2|종로선 3호차">동해행(종로선) 3호차</option>
                                    <option value="">-------</option>
