...
<div class="bd_tl" style="width:100%;">
	<h1 class="ngeb clear"><i class="bg_color"></i>셔틀버스 예약관리</h1>
</div>
            ...
            <div class="tab_container" style="margin-left:5px;">
                ...
                <div id="tab1" class="tab_content">
                    ...
                    <table class='et_vars exForm bd_tb' style="width:100%">
                        ...
                        <tr>
                            <th><label><input type="checkbox" id="chkBusD1" name="chkBus[]" checked="checked" value="14" style="vertical-align:-3px;" onclick="fnChkBusAll(this, 'D1')" />서울출발</label></th>
                            <td>
                            ...
                            <th><label><input type="checkbox" id="chkBusD2" name="chkBus[]" checked="checked" value="14" style="vertical-align:-3px;" onclick="fnChkBusAll(this, 'D2')" />서울복귀</label></th>
                            <td>
                        ...
                        <tr>
                            <td colspan="4" style="text-align:center;">
                                <input type="button" class="gg_btn gg_btn_grid large gg_btn_color" style="width:120px; height:40px;" value="검색" onclick="fnSearchAdmin('bus_mohaeng/list_search.php');" />
                            </td>
                        </tr>
                    </table>
                    </form>                
						...
						<tbody>
							...
							<tr id="trbus" style="display:none;">
								...
								<td>
                                    ...
                                    <select id="res_busnum" name="res_busnum" class="select" disabled="disabled">
                                        <option value="ESa1">서울출발 1호차</option>
                                        <option value="ESa2">서울출발 2호차</option>
                                        <option value="ESa3">서울출발 3호차</option>
                                        <option value="AE21">서울복귀 1호차</option>
                                        <option value="AE22">서울복귀 2호차</option>
                                        <option value="AE23">서울복귀 3호차</option>
                                    </select>
								</td>
