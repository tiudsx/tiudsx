...
<?
$select_query_sub = "SELECT a.user_name, a.user_tel, a.etc, a.resseq, b.res_seat, b.res_spointname, c.couponseq FROM 
						`AT_RES_MAIN` as a INNER JOIN `AT_RES_SUB` as b 
							ON a.resnum = b.resnum 
                                AND b.code = 'bus'
							LEFT JOIN AT_COUPON_CODE c
				...
				<td style="vertical-align:top;">
					...
					?>
						<tr>
							...
							<td style="padding:4px;text-align:center;"><?=fnBusPointArr2023($busTitle.$arrData[1], 14, 1)?></td>
							<td style="padding:4px;text-align:left;">&nbsp;<?=fnBusPointArr2023($busTitle.$arrData[1], 14, 0)?></td>
