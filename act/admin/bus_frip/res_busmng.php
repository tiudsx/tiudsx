...
$select_query_bus = "SELECT seq, shopname, res_busnum, res_confirm, COUNT(*) AS CntBus FROM `AT_RES_FRIP_SUB` 
						WHERE code = 'bus'
...
function fnDayList(vlu, obj){
	...
	if(vlu == "ALL"){
		...
		$j.post("/act/admin/bus_frip/res_busmnglist.php", formData,
