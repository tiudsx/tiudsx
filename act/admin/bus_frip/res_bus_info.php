...
if($param == "busview"){ //상세정보
    ...
    $select_query = "SELECT a.*, b.*, d.couponseq FROM AT_RES_FRIP_MAIN as a 
                        INNER JOIN AT_RES_FRIP_SUB as b 
    ...
    $select_query = "SELECT a.user_name, a.user_tel, a.user_email, b.* FROM `AT_RES_FRIP_MAIN` as a INNER JOIN `AT_RES_FRIP_SUB` as b ON a.resnum = b.resnum WHERE b.ressubseq = $ressubseq";
    $result = mysqli_query($conn, $select_query);
    $count_sub = mysqli_num_rows($result);
