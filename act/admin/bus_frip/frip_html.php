...
if($param == 2 || $param == 3){
   ...
   while ($rowSub = mysqli_fetch_assoc($resultSite)){
      ...
      if($param == 3){
         ...
         //$kakaoMsg = $msgTitle.'\n\n안녕하세요. 액트립 예약고객님\n액트립 셔틀버스를 예약해주셔서 감사드립니다.\n취소/환불에 관해 안내드립니다.\n\n취소/환불 유의사항 안내\n ▶ 예약자 : '.$user_name.'\n---------------------------------\n ▶ 안내사항\n액트립 셔틀버스는 이용일 기준 4일전 전액환불, 3일전 환불불가 정책으로 운영되고 있습니다.\n\nex. 이용일이 8월 20일인 경우 8월 16일 23시 59분까지는 전액 환불 가능\n※ 버스 탑승 시간 미준수로 환불 및 시간 변경은 불가\n\n이점 참고하셔서 액트립 셔틀버스 이용부탁드립니다.\n\n고객님들 모두 불편함 없는 즐거운 주말 여행이 되시길 바랍니다.\n\n감사합니다~';
         $kakaoMsg = $msgTitle.'\n\n안녕하세요. 액트립 예약고객님\n액트립 셔틀버스를 예약해주셔서 감사드립니다.\n이용하실 탑승 정류장에 관해 안내드립니다.\n\n셔틀버스 정류장 안내\n ▶ 예약자 : '.$user_name.'\n---------------------------------\n ▶ 안내사항\n액트립 셔틀버스는 서울 > 양양행, 양양 > 서울행 두개의 노선을 운행하고 있습니다.\n\n각 노선의 정류장 위치/탑승 시간은 예약하실 때 안내되어 있으나 탑승전 한번더 안내드리고자 연락드렸습니다.\n\n정류장 안내 : http://actrip.co.kr/pointlist\n\n위 링크에서 예약하신 정류장/탑승 시간 확인 후 이용 부탁드립니다.\n\n고객님들 모두 불편함 없는 즐거운 주말 여행이 되시길 바랍니다.\n\n감사합니다~';

         //$kakaoMsg = $msgTitle.'\n\n안녕하세요. 액트립 예약고객님\n액트립 셔틀버스를 예약해주셔서 감사드립니다.\n셔틀버스 이용에 관해 안내드립니다.\n\n셔틀버스 유의사항 안내\n ▶ 예약자 : '.$user_name.'\n ▶ 정류장 안내 : http://actrip.co.kr/pointlist\n---------------------------------\n ▶ 안내사항\n액트립 셔틀버스 정류장 안내\n\n서울 > 양양행, 양양 > 서울행 두개의 노선을 운행하고 있습니다.\n\n각 노선의 정류장 위치/탑승 시간은 예약하실 때 안내되어 있으나 탑승전 한번더 안내드리고자 연락드렸습니다.\n\n위 링크에서 예약하신 정류장/탑승 시간 확인 후 이용 부탁드립니다.\n\n취소/환불 안내\n\n액트립 셔틀버스는 예약하신 사이트에 따른 각각의 환불정책으로 운영되고 있습니다.\n\n환불정책 환인 하시고 이용 부탁드리며, 버스 탑승 시간 미준수로 인한 환불 및 일정변경은 불가합니다.\n\n이점 참고하셔서 액트립 셔틀버스 이용부탁드립니다.\n\n고객님들 모두 불편함 없는 즐거운 주말 여행이 되시길 바랍니다.\n\n감사합니다~';
      }
